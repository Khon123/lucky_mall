...
@section('header')
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Area Detail</li>
		</ol>
	</section>
@endsection
				...
				<div class="box-header with-border">
					<form id="frmEdit" name="frmEdit" class="hide form">
						...
						<div class="form-group">
							<textarea class="form-control my-editor" id="detail" name="detail"></textarea>
						</div>
					...
					<table class="table table-bordered" id="table">
						...
						@foreach($areaDetails as $row)
							<tr id="about{{$row->id}}">
								...
								<td class="text-center" id="id_detail{{ $row->id }}"><?php echo html_entity_decode($row->detail)?></td>
	...
	<script type="text/javascript">
        ...
        $('#edit-des').click(function () {
            ...
            $.get(url+'/'+id, function (data) {
                ...
                if(des != null){
                    tinymce.editors['detail'].setContent(des);
                }else{
        ...
        $('#update').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var des = data.detail;
                    console.log(des)
                    var col_des='<td class="text-center" id="id_detail'+data.id+'">'+des+'</td>';

                    $("#id_detail" + id).replaceWith( col_des );
