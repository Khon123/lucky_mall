                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-info" id="update"><span> USE </span></button>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12" id="image-list">
                                            @foreach($masterImages as $image)
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <button id="dd" class="image" value="{{ $image->id }}" style="background: none; border: none"> <img src="{{ url('images').'/'. $image->name }}" style=" border-radius: 5px; width: 200px; height: 200px; border: solid 1px #31CCFF;margin-bottom: 7px;"> </button>
                                                </div>
                                            @endforeach
