...
<head>
    ...
    {{--dropzone--}}
    <link rel="stylesheet" href="{{ asset('vendor/adminlte/') }}/bootstrap/css/dropzone.min.css">
...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
      ...
      <footer class="main-footer">
        @if (config('backpack.base.show_powered_by'))
            <div class="pull-right hidden-xs">
              {{ trans('backpack::base.powered_by') }} <a target="_blank" href="http://www.cstcambodia.com/">CST</a>
            </div>
        @endif
    ...
    <script src="{{ asset('vendor/adminlte') }}/bootstrap/js/html5shiv.min.js"></script>
    <script src="{{ asset('vendor/adminlte') }}/bootstrap/js/respond.min.js"></script>
    <![endif]-->

    {{--dropzone--}}
    <script src="{{ asset('vendor/adminlte') }}/bootstrap/js/dropzone.min.js"></script>
    {{--  CKeditor  TinyMCE4 --}}
